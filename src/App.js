  ...
  return (
    <div className="container">
      ...
      <div className="text-center mt-5 mb-1 form-group">
        <input type="text" name="" id="" className="form-control" value={searchValue} onChange={(e)=>{setSearchValue(e.target.value)}}/>
        <button className="btn btn-success mt-3 mx-2 px-5 py-2">Search</button>
      </div>
      <div className="text-center">
        <button className="btn btn-primary m-2 px-3 py-2">
          Sort by name
        </button>
        <button className="btn btn-primary m-2 px-3 py-2">
          Sort by Price
